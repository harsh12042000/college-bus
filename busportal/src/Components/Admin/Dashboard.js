              ...
              <div className="our_solution_category">
                ...
                <div className="solution_cards_box sol_card_top_3">
                  <div className="solution_card">
                    ...
                    <div className="solu_description">
                      <p></p>
                      <button type="button" className="read_more_btn" onClick={() => navigate("/adddriver")}>
                        Click Here
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="solution_card">
                    ...
                    <div className="solu_title">
                      <h3>All Bus Details</h3>
                    </div>
                    <div className="solu_description">
                      <p></p>
                      <button type="button" className="read_more_btn" onClick={() => navigate("/busdetails")}>
                        Click Here
                      </button>
                    </div>
                  </div>
                ...
                <div className="solution_cards_box sol_card_top_3">
                  <div className="solution_card">
                    ...
                    <div className="solu_description">
                      <p></p>
                      <button type="button" className="read_more_btn" onClick={() => navigate("/driverdetails")}>
                        Click Here
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="solution_card">
                    ...
                    <div className="solu_description">
                      <p></p>
                      <button type="button" className="read_more_btn" onClick={() => navigate("/studentdetails")}>
                        Click Here
                      </button>
                    </div>
                  </div>
