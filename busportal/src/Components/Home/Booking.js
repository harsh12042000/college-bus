...
export default function Booking() {
  ...
  return (
    ...
    //         <div className='row-sm-12 row-md-5 mb-3 ms-5' style={{ width: "30vw", alignItems: "center", boxShadow: "5px 5px 20px rgb(138, 37, 64)" }}>
    //           <div className='col fs-5 fw-bold ms-5'>Name :</div>
    //           <div className='col me-1'>{source}</div>
    //         </div>
    //         <div className='row-sm-12 mb-3 ms-5' style={{ width: "30vw", alignItems: "center", boxShadow: "5px 5px 20px rgb(138, 37, 64)" }}>
